...
void solve()
{
    ...
    {
        Income = 50000 + (X - 7500) / 0.40;
    }
    else if (X <= 42500) 
    {
        Income = 100000 + (X - 27500) / 0.60;
    }
    else if (X <= 52500) 
    {
        Income = 100000 + (X - 32500) / 0.40;
    }
    else 
    {
        Income = 150000 + (X - 52500) / 0.45;
    }
    Output_precision(10,Income);
}
